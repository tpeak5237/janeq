...
const strings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    scannerFullFrameHint: "The whole camera frame is scanned, not just the guide.",
    ...
    lowLightHint: "Low light. Try turning on a light for a faster scan.",
  ...
  th: {
    ...
    scannerFullFrameHint: "ระบบสแกนทั่วทั้งภาพ ไม่ได้จำกัดเฉพาะกรอบนำสายตา",
    ...
    lowLightHint: "แสงน้อย ลองเปิดไฟเพื่อสแกนได้เร็วขึ้น",
